    ...
    (b.prototype = {
        _generate: function () {
            return a.support.canvas
                ? ((this.canvas = document.createElement("canvas")),
                  ...
                  (this.$scratchpad = a(this.canvas).css({ position: "absolute", width: "100%", height: "100%" })),
        ...
        reset: function () {
            ...
            (this.pixels = c * d),
                ...
                (this.pixels = c * e * d * e),
                this.$img.hide(),
                this.options.bg && ("#" === this.options.bg.charAt(0) ? this.$el.css("backgroundColor", this.options.bg) : (this.$el.css("backgroundColor", ""), this.$img.attr("src", this.options.bg))),
                this.options.fg &&
                    ("#" === this.options.fg.charAt(0)
                        ? ((this.ctx.fillStyle = this.options.fg), this.ctx.beginPath(), this.ctx.rect(0, 0, c, d), this.ctx.fill(), this.$img.show())
                        : a(new Image())
        ...
        (a.fn.wScratchPad.defaults = { size: 5, bg: "#cacaca", fg: "#6699ff", realtime: !0, scratchDown: null, scratchUp: null, scratchMove: null, cursor: "crosshair" }),
